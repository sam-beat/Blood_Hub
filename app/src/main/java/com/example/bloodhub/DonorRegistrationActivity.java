                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                ...
                                if(resultUri != null){
                                              ...
                                              if(taskSnapshot.getMetadata() != null && taskSnapshot.getMetadata().getReference() != null){
                                                  ...
                                                  result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                     ...
                                                     userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                         ...
                                                         public void onComplete(@NonNull Task task) {
                                                        if(task.isSuccessful()){
                                                            Toast.makeText(DonorRegistrationActivity.this,"Image url added", Toast.LENGTH_SHORT).show();
                                                        }
                                                        else{
                                                            Toast.makeText(DonorRegistrationActivity.this, task.getException().toString(),Toast.LENGTH_LONG).show();
                                                        }
                                    ...
                                    Intent i = new Intent(DonorRegistrationActivity.this,MainActivity.class);
                                    startActivity(i);
                                    finish();
                                    loader.dismiss();
                                }
